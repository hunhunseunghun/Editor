...
async function createTestDocument() {
  ...
  try {
    ...
    // 테스트 사용자 생성 또는 찾기
    let testUser = await db.collection('users').findOne({ email: 'test@lumireditor.com' });
    ...
    if (!testUser) {
      ...
      testUser = { _id: userResult.insertedId, email: 'test@lumireditor.com', name: 'Lumir Test User' };
        ...
        content: JSON.stringify([
          {
            ...
            type: 'heading',
            props: { level: 1 },
            content: [{ type: 'text', text: 'Welcome to Lumir Editor!', styles: {} }],
            children: []
          },
          {
            id: 'block-2',
          ...
          },
          {
            ...
            type: 'bulletListItem',
            props: {},
            content: [{ type: 'text', text: 'Document management', styles: {} }],
            children: []
          },
          {
            id: 'block-6',
            type: 'bulletListItem',
            props: {},
            content: [{ type: 'text', text: 'Folder organization', styles: {} }],
            children: []
          }
        ]),
        user: testUser._id,
